# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-20 06:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('d', 'Maintenance'), ('o', 'On load'), ('a', 'Available'), ('r', 'Reserved')], default='d', help_text='Book availability', max_length=1)),
